...
- `scripts/03_firewall/08_install_wireguard.sh` - installatie van WireGuard.
- `scripts/04_system/09_verify_and_repair.sh` - controleert of alles correct is geïnstalleerd/geconfigureerd en probeert mislukte onderdelen gericht opnieuw.
- `scripts/04_system/10_cleanup.sh` - cleanup.
