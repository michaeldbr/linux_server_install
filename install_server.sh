...
echo "[8/11] Webmin installeren, gebruiker '${MICHAEL_USER}' aanmaken en poort ${WEBMIN_PORT} instellen..."
"${SCRIPT_DIR}/scripts/04_webmin/08_install_webmin.sh"

echo "[9/11] WireGuard installeren..."
...
echo "Klaar. SSH draait op poort ${SSH_PORT}. Webmin draait op poort ${WEBMIN_PORT}. Tijdzone staat op Europe/Amsterdam."
